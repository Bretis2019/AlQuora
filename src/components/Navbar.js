...
export default function Navbar(props){
    ...
    return(
        <div>
            <div className={"z-80 block fixed min-h-[60px] dark:bg-gray-900 bg-gray-100"}>
                <div className={"px-2 md:px-[15%] flex align-center justify-between w-screen min-h-[50px] dark:bg-gray-800  bg-white py-1 pt-2 shadow-nav"}>
                    ...
                    <input  onChange={e => props.handleChange(e.target.value)} className={"dark:bg-gray-800 rounded-md w-24 md:w-96 px-2 max-h-9 shadow-nav"} type={"text"} placeholder={"Search..."}/>
